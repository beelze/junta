...
SRC_URI="mirror://openbsd/OpenSSH/portable/${PARCH}.tar.gz
	${SCTP_PATCH:+https://dev.gentoo.org/~vapier/dist/${SCTP_PATCH}}
	${HPN_PATCH:+hpn? ( https://dev.gentoo.org/~vapier/dist/${HPN_PATCH} )}
	${LDAP_PATCH:+ldap? ( https://dev.gentoo.org/~vapier/dist/${LDAP_PATCH} )}
