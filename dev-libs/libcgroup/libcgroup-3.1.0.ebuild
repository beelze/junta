...
SRC_URI="https://github.com/libcgroup/libcgroup/releases/download/v3.1.0/${P}.tar.gz"

LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="amd64 arm arm64 ~ppc ~ppc64 ~riscv x86"
IUSE="+daemon pam static-libs test +tools -systemd"
...
src_install() {
	...
	doins samples/config/cgsnapshot_allowlist.conf
